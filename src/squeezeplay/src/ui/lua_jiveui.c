...
TOLUA_API int tolua_jive_open (lua_State* tolua_S)
{
 ...
 tolua_beginmodule(tolua_S,"jive");
  ...
  tolua_beginmodule(tolua_S,"ui");
   ...
   tolua_constant(tolua_S,"KEY_PRESET_0",JIVE_KEY_PRESET_0);
   ...
   tolua_constant(tolua_S,"KEY_PRESET_7",JIVE_KEY_PRESET_7);
   tolua_constant(tolua_S,"KEY_PRESET_8",JIVE_KEY_PRESET_8);
   tolua_constant(tolua_S,"KEY_PRESET_9",JIVE_KEY_PRESET_9);
