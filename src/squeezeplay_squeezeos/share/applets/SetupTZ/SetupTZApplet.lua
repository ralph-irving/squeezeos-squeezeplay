...
local timezones = {
	...
	{ strid = "TZ_AMERICA_INDIANAPOLIS", olson = "America/Indiana/Indianapolis" },
	...
	{ strid = "TZ_AMERICA_BUENOS_AIRES", olson = "America/Argentina/Buenos_Aires" },
	{ strid = "TZ_AMERICA_NUUK", olson = "America/Nuuk" },
	...
	{ strid = "TZ_AFRICA_MONROVIA", olson = "Africa/Monrovia" },
	...
	{ strid = "TZ_ASIA_DUBAI", olson = "Asia/Dubai" },
	...
	{ strid = "TZ_ASIA_KOLKATA", olson = "Asia/Kolkata" },
	{ strid = "TZ_ASIA_COLOMBO", olson = "Asia/Colombo" },
	{ strid = "TZ_ASIA_KATHMANDU", olson = "Asia/Kathmandu" },
	{ strid = "TZ_ASIA_DHAKA", olson = "Asia/Dhaka" },
	{ strid = "TZ_ASIA_ALMATY", olson = "Asia/Almaty" },
	{ strid = "TZ_ASIA_YANGON", olson = "Asia/Yangon" },
